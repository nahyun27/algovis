...
const PROBLEMS = [
  { id: 1197, title: '최소 스패닝 트리', tier: 'Gold IV',  nLimit: 'V,E ≤ 10,000', note: '기본 크루스칼 / 프림' },
  { id: 1922, title: '네트워크 연결',     tier: 'Gold IV',  nLimit: 'N ≤ 1,000',     note: '크루스칼 + Union-Find' },
  { id: 4386, title: '별자리 만들기',     tier: 'Gold III', nLimit: 'N ≤ 100',        note: '좌표 MST' },
  { id: 1647, title: '도시 분할 계획',   tier: 'Gold II',  nLimit: 'N ≤ 100,000',   note: 'MST 변형 (두 마을 분리)' },
];
